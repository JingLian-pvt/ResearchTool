...
poscar = Poscar.from_file("/home/jinglian/Documents/crystal-structure/NiFeOOH/vcrelax/Uniform/relaxed.cube.vasp")
pmg_struct = poscar.structure


miller = [0,0,1]
slabsize= 12 #in angstrom , thickness of the slab to generate
...
for slab in slabs:
    ...
    w = CifWriter(slab)
    w.write_file('/home/jinglian/Documents/crystal-structure/NiFeOOH/SLABS/Uniform/001slab'+str(i)+'.cif')
